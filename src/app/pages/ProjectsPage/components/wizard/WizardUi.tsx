...
export const wizardLayoutStyles = {
  ...
  journeyStack: { display: "grid", gap: uiTokens.spacing.lg } as CSSProperties,
  journeyPairGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: uiTokens.spacing.lg } as CSSProperties,
  journeyTripleGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: uiTokens.spacing.md } as CSSProperties,
